                ...
                <div className="sidebar-themeContainer">
                    ...
                    >
                        ...
                        <div className="sidebar-themeType light">
                            ...
                            <span className="sidebar-themeInputText">Светлый</span>
                        </div>
                        <div className="sidebar-themeType dark">
                            ...
                            <span className="sidebar-themeInputText">Темный</span>
                        </div>
                    </label>
                </div>
                <ul className="sidebar-list">
                <li className="sidebar-listItem active">
                        <a onClick={() => handleButtonClick('MainInfo')}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                stroke="currentColor"
                            ...
                            <span className="sidebar-listItemText">Стена</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem active">
                    ...
                    <li className="sidebar-listItem">
                        <a onClick={() => handleButtonClick('Weather')}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <span className="sidebar-listItemText">Погода</span>
                        </a>
                    </li>

                    <li className="sidebar-listItem">
                        <a onClick={() => handleButtonClick('Todo')}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <span className="sidebar-listItemText">Задачи</span>
                        </a>
                    </li>
                    
                    <li className="sidebar-listItem">
                        <a onClick={() => handleButtonClick('Vk')}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <span className="sidebar-listItemText">ВК Плейлисты</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a onClick={() => handleButtonClick('Shelter')}>
                            ...
                            <span className="sidebar-listItemText">Шелтер(beta)</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Телеграмм канал</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Форум</span>
                        </a>
                    </li>
                    ...
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Мероприятия</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Фильмы</span>
                        </a>
                    </li>
