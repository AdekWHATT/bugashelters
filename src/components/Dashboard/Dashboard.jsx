                ...
                <ul className="sidebar-list">
                    ...
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Развлечения</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Здоровья</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Науки</span>
                        </a>
                    </li>
                    ...
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Спорта</span>
                        </a>
                    </li>
                    <li className="sidebar-listItem">
                        <a>
                            ...
                            <span className="sidebar-listItemText">Технологии</span>
                        </a>
                    </li>
                </ul>
